            ...
            <div class="content">
                ...
                if ($_POST['send'] == 1) {
                    ...
                    if (!$login or empty($login)) {
                        echo ( '<center><p class="error">Wypełnij pole z loginem!</p></center>');
                    }

                    if (!$pass or empty($pass)) {
                        echo('<h5><p class="error">Wypełnij pole z hasłem!</p></h5>');
                    }
                    ...
                    if ($userExists[0] == 0) {
                        ...
                        echo '<center><p class="error">Użytkownik o podanym loginie lub haśle nie istnieje.</p></center>';
                    }
                        ...
                        echo '<center><p class="success">Zostałeś zalogowany. Możesz przejść na <a href="adminindex.php"><button>stronę panelu admina</button></a> lub możesz <a href="../log/logout.php"><button>Wylogować</button></a> się </center>';
