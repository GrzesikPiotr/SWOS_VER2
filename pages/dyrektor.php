            ...
            <div class="content">
                ...
                <!-- CONTENT -->
                        <?php
                             ...
                             * SKRYPT LOGOWANIA
                             */
                            require_once 'dyrektor.class.php'; // Dołączamy rdzeń systemu użytkowników
                            ...
                            if ($_POST['send'] == 1) {
                                ...
                                if (!$login or empty($login)) {
                                    die ('<center><p class="error">Wypełnij pole z loginem!</p></center>');
                                }

                                if (!$pass or empty($pass)) {
                                    die ('<center><p class="error">Wypełnij pole z hasłem!</p></center>');
                                }
